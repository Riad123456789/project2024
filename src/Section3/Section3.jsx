            ...
            <div style={{
                ...
                <div className=" bg-gradient-to-r from-[black] to-[#433e3e] opacity-60 w-full h-full pt-8">
                    ...
                    <div className="  mt-6 w-32 mx-auto ">
                        {/* <button type="button" className="text-black bg-gradient-to-r  from-lime-200 via-lime-400 to-lime-500 hover:bg-gradient-to-br  focus:outline-none focus:ring-lime-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 font-sans  ">
                            Shop Now
                        </button> */}
                    </div>
                </div>
