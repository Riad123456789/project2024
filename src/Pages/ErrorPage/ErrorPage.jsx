...
const ErrorPage = () => {
    return (
        <div className="bg-gray-50 h-screen flex ">
            <div className="max-w-screen-xl mx-auto p-10  flex items-center">
                <div className="container flex flex-col md:flex-row items-center justify-between px-5 text-gray-700 mx-auto">
                    <div className="w-full lg:w-1/2 mx-8">
                        ...
                        <Link to='/' className="px-5 inline py-3 text-sm font-medium leading-5 shadow-2xl text-white transition-all duration-400 border border-transparent rounded-lg focus:outline-none bg-green-600 active:bg-red-600 hover:bg-red-700">
                            back to homepage
                        </Link>
                    </div>
